      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-neutral-400 text-sm">
              Premium T-shirts crafted with care. Sustainable, transparent, and built to last.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-neutral-400">
              <li><Link href="/shop/mens" className="hover:text-white transition-colors">Men's</Link></li>
              <li><Link href="/shop/womens" className="hover:text-white transition-colors">Women's</Link></li>
          ...
          {/* Company */}
          <div>
            <h4 className="font-semibold mb-4 uppercase tracking-wide text-sm">Company</h4>
            <ul className="space-y-2 text-sm text-neutral-400">
        ...
        <div className="mt-12 pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-neutral-400">
            © 2024 Essential. All rights reserved.
          </p>
